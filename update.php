...
$insert=false;
 ...
 //form validation using php
  ...
  $sql=" UPDATE `studenttable` SET `sln`=$sln,`firstname`='$firstname',`lastname`='$lastname',`fathername`='$fathername',`address`='$address',`mobile`='$phone',`email`='$email',`time`=current_timestamp() WHERE sln=$sln ";
  
  $query=mysqli_query($con,$sql);
  
  //for redirection to view.php
...
<html lang="eng">
  ...
  <body>
    <nav class="navbar navbar-expand-lg bg-info">
       ...
       <br>
       <h1>Welcome to the Student data Update Page</h1>
       <?php
       if($insert==true)
          {
